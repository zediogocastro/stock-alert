...
class Returns(Feature):
    ...
    def __init__(
        self, column: str, n_days: int, sort_by: str, group_by: str | None
    ) -> None:
        self.column = column
        self.n_days = n_days
...
class Volatility(Feature):
    ...
    def __init__(
        self, column: str, window_days: int, sort_by: str, group_by: str | None = None
    ):
        self.column = column
...
class Lag(Feature):
    ...
    def __init__(
        self, column: str, n_days: int, sort_by: str, group_by: str | None = None
    ):
        self.column = column
        self.n_days = n_days
        self.sort_by = sort_by
